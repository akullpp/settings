...
```
sudo apt install bat docker docker-compose git glances httpie jq keepassxc p7zip tldr zsh curl autojump gnome-tweaks ffmpeg libreoffice
```
...
```
sudo snap install code kubectl postman dbeaver-ce intellij-idea-ultimate zoom-client --classic
```
